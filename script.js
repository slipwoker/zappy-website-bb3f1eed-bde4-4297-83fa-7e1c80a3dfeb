      ...
      (async function() {
        try {
          ...
          const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
            ...
            body: JSON.stringify({
              websiteId: 'bb3f1eed-bde4-4297-83fa-7e1c80a3dfeb',
              name: data.name || '',
              email: data.email || '',
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "israeliwins uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
